...
//void Main_PIREventHandler(uint8_t pirAction);//Ham xu ly khi co su thay doi cam bien chuyen dong
...
//		{//Kiem tra mang da va chua
//		static boolean sendFlag = true;
//		switch (pirAction) {
//			case PIR_MOTION: //Truong hop co chuyen dong
//				//emberAfCorePrint("Motion");
//				if(sendFlag)
//				{
//					sendFlag = false;
//					SEND_PIRStateReport(5,PIR_MOTION); //Gui thong bao len HC
//				}
//				toggleLed(LED1,ledPink,1,500,500);//Nhay led bao hieu
//				break;
//			case PIR_UNMOTION: //Truong hop khong co chuyen dong
//				//emberAfCorePrint("UnMotion");
//				sendFlag = true;
//				toggleLed(LED1,ledRed,1,500,500);//Nhay led bao hieu
//				emberAfCorePrintln("PIR_UNMOTION");
//				SEND_PIRStateReport(5,PIR_UNMOTION); //gui thong bao len HC
//				break;
//
//			default:
//				break;
